...
namespace CoreEngine.Domain.AutoMapper
{
    public static class MappingExtensions
    {
        ...
        public static TModel ToModel<TModel>(this Entity entity) where TModel : BaseEntityModel
        {
            if (entity == null)
        ...
        public static TModel ToModel<TEntity, TModel>(this TEntity entity, TModel model)
            where TEntity : Entity where TModel : BaseEntityModel
        {
            if (entity == null)
                throw new ArgumentNullException(nameof(entity));
        ...
        public static TEntity ToEntity<TEntity>(this BaseEntityModel model) where TEntity : Entity
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
